     ...
     <div class ="col-sm-12" style="padding-left:0px;padding-right:0px;">
        ...
        <div class="col-sm-12">
            ...
            <div id="add-movie-form-container">
                <form class="form-horizontal" method="post" id="add-movie-form"
                      action="" autocomplete="off" enctype="multipart/form-data" />
                        ...
                        <select data-placeholder="Select Genre(s)..." multiple class="form-control genre"  name="genres[]" id="genre[]">
                            <?php
                                ...
                                foreach ($genres as $key => $genre) {
                                    $found = false;
                                    foreach ($current_genres as $key => $current_genre) {                                        
                                        if ($genre['gnr_name'] == $current_genre) { ?>
                                            <option value="<?= $genre['gnr_id'] ?>" selected="selected"><?= $current_genre ?></option>
                                            <?php 
                                             $found = true;
                                             break;
                                        }
                                    } // end inner loop for current genres 
                                    if(!$found) { ?>
                                        <option value="<?php echo $genre['gnr_id']; ?>"><?php echo $genre['gnr_name'];?></option>    
                                    <?php 
                                            } 
                                        } // end outer loop for genres  
                                    ?>
                    ...
                    <div class="form-group">
                        ...
                        <img src="../<?= $movie[0]['img_path'] ?>" alt="<?= $movie[0]['mv_title'] ?>">
                        <div class="col-sm-10">
